        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                   ...
                   <li class="treeview">
                    ...
                    <li class="treeview">
                           ...
                           <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="surat_keluar/create"><i class="fa fa-angle-double-right"></i>Entri Baru</a></li>
                                <li><a href="surat_keluar/index"><i class="fa fa-angle-double-right"></i>Data</a></li>
                            </ul>
                        </li>
            ...
            <aside class="right-side">
                ...
                <!-- Main content -->
                        ...
                        <form action="{{ url('surat_keluar/edit') }}" class="col s12" method="post" enctype="multipart/form-data">
                                    {!! csrf_field() !!}
     ...
     @if($errors->first('mail_subject'))
                                        ...
                                        @endif
                                          ...
                                          <div class="form-group col-md-6">
                                            ...
                                            <textarea class="form-control"  name="description" rows="3" class="form-control" class="{{ $errors->first() ? "
