        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <!-- Main content -->
                        ...
                        <form action="{{ url('Admin/edit') }}" class="col s12" method="post" enctype="multipart/form-data">
                                    {!! csrf_field() !!}
                                    ...
                                    <!-- Date dd/mm/yyyy -->
                                        ...
                                        <div class="form-group ">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" value="{{ $user->email }}" id="exampleInputEmail1" placeholder="Enter email" name="email">
                                        </div>
                                       ...
                                       <div class="form-group ">
                                            ...
                                            <input type="password"  name="password" value="{{ $user->password }}"" class="form-control" placeholder="Enter ..."/>
                                        </div>
