        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <!-- Main content -->
                        ...
                        <form action="{{ url('surat_masuk/create') }}" class="col s12" method="post" enctype="multipart/form-data">
                                    {!! csrf_field() !!}
...
@if($errors->first('mail_from'))
    ...
    invalid" : "" }}" name="file_upload" id="exampleInputFile">
                                        ...
                                        @endif
                                            ...
                                            <input type="hidden" name="mail_typeid" value="1" class="form-control"  class="{{ $errors->first() ? "
    invalid" : "" }}" placeholder="Enter ..."/>
