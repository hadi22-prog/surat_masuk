        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                  ...
                  <a href="{{url('disposisi/index')}}">
                    ...
                    <li class="treeview">
                           ...
                           <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="pages/tables/simple.html"><i class="fa fa-angle-double-right"></i>Entri Baru</a></li>
                                <li><a href="pages/tables/data.html"><i class="fa fa-angle-double-right"></i>Data</a></li>
                            </ul>
                        </li>
            ...
            <aside class="right-side">
                ...
                <!-- Main content -->
                        ...
                        <form action="{{ url('surat_masuk/edit') }}" class="col s12" method="post" enctype="multipart/form-data">
                                    {!! csrf_field() !!}
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="incoming_at" value="{{ $mail->incoming_at }}" class="form-control" class="{{ $errors->first() ? "
    invalid" : "" }}" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/>
                                        </div><!-- /.input group -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text"  name="mail_code" class="form-control"  class="form-control" class="{{ $errors->first() ? "
    invalid" : "" }}" value="{{ $mail->mail_code}}" placeholder="Enter ..."/>
                                      ...
                                      @if($errors->first('mail_code'))
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="mail_date" class="form-control" class="{{ $errors->first() ? "
    invalid" : "" }}" value="{{ $mail->mail_date}}" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/>
                                        </div><!-- /.input group -->
                                       ...
                                       <div class="form-group col-md-6">
                                            ...
                                            <input type="text"  name="mail_from" class="form-control" class="form-control" class="{{ $errors->first() ? "
    invalid" : "" }}" value="{{$mail->mail_from}}" placeholder="Enter ..."/>
                                        ...
                                        @endif
                                           ...
                                           <div class="form-group col-md-6">
                                            <label>Mail To</label>
                                            <input type="text"  name="mail_to" class="form-control" class="form-control" class="{{ $errors->first() ? "
    invalid" : "" }}" value="{{$mail->mail_to}}" placeholder="Enter ..."/>
     @if($errors->first('mail_to'))
                                        ...
                                        @endif
                                           ...
                                           <div class="form-group col-md-6"> 
                                            ...
                                            <input type="text"  name="mail_subject" class="form-control" class="form-control" class="{{ $errors->first() ? "
    invalid" : "" }}" value="{{$mail->mail_subject}}" placeholder="Enter ..."/>
     @if($errors->first('mail_subject'))
                                        ...
                                        @endif
                                          ...
                                          <div class="form-group col-md-6">
                                            ...
                                            <textarea>      </textarea>a class="form-control"  name="description" rows="3" class="form-control" class="{{ $errors->first() ? "
    invalid" : "" }}" placeholder="Enter ...">{{$mail->description}}</textarea>
     @if($errors->first('description'))
                                        ...
                                        @endif
                                           ...
                                           <div class="form-group col-md-6">
                                            ...
                                            <input type="file"  name="file_upload" value="{{$mail->file_upload}}" class="{{ $errors->first() ? "
    invalid" : "" }}"  id="exampleInputFile">
