        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <!-- Main content -->
                        ...
                        <form action="{{ url('mail/create') }}" class="col s12" method="post" enctype="multipart/form-data">
                                    {!! csrf_field() !!}
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="incoming_at" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/>
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                         <!-- text input -->
                                        <div class="form-group">
                                            <label>Mail Code</label>
                                            <input type="text"  name="mail_code" class="form-control" placeholder="Enter ..."/>
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="mail_date" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/>
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group --> 
                                       <div class="form-group">
                                            <label>Mail From</label>
                                            <input type="text"  name="mail_from" class="form-control" placeholder="Enter ..."/>
                                        </div>
                                           <div class="form-group">
                                            <label>Mail To</label>
                                            <input type="text"  name="mail_to" class="form-control" placeholder="Enter ..."/>
                                        </div>

                                           <div class="form-group"> 
                                            <label>Mail Subject</label>
                                            <input type="text"  name="mail_subject" class="form-control" placeholder="Enter ..."/>
                                        </div>
                                          ...
                                          <div class="form-group">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <p class="help-block">upload File Max 2048KB</p>
                                             ...
                                             <div class="form-group">
                                            <label>Select</label>
                                            <select class="form-control" name="mail_typeid">
                                               @foreach($type_mail as $key)
                                                @if(isset($barang->mail_typeid))
                                                 @if($mail->type_mail==$key->id)
                                                <option selected value="{{$key->id}}">{{$key->type_mail}}</option>

                                                 @else
                                                <option value="{{$key->id}}">{{$key->type_mail}}</option>
                                              @endif
                                                @else
                                      <option value="{{$key->id}}">{{$key->type_mail}}</option>
                                                  @endif
